...
//        }
        ...
        //LogicSystem.current.InitModelObjs();
	}
    ...
    protected virtual void CalibrateUser(Int64 userId, int bodyIndex)
    {
		if(!alUserIds.Contains(userId))
		{
			if(CheckForCalibrationPose(userId, bodyIndex, playerCalibrationPose))
			{
                ...
                //LogicSystem.current.ModelObjs[uidIndex].SetActive(true);
                //LogicSystem.current.OpenAllPAtternShow();
                //LogicSystem.current.MagnectObj_A.SetActive(true);
                //LogicSystem.current.MagnectObj_B.SetActive(true);
...
//				}
	...
	protected virtual void RemoveUser(Int64 userId)
	{
        ...
        //LogicSystem.current.ModelObjs[uidIndex].SetActive(false);
...
//		}
		...
		if(alUserIds.Count == 0)
		{
            ...
            //LogicSystem.current.MagnectObj_A.SetActive(false);
            //LogicSystem.current.MagnectObj_B.SetActive(false);

            //LogicSystem.current.ResetPatternPosition();
